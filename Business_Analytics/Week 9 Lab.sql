...
SELECT 
	...
	,SUM(CASE WHEN YEAR(StartDate) = '2004' THEN 1 ELSE 0 END) NUM_2004
	,SUM(CASE WHEN YEAR(StartDate) = '2005' THEN 1 ELSE 0 END) NUM_2005
	,SUM(CASE WHEN YEAR(StartDate) = '2006' THEN 1 ELSE 0 END) NUM_2006
FROM Subscribers
